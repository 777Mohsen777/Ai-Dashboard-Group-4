...
if uploaded_file is not None:
    try:
        ...
        if all(col in df.columns for col in required_columns):
            ...
            axes[0].scatter(df['Operating_Hours'], df['Temperature'], color='red', alpha=0.5, s=15, label='Engine Oil Temp')
            ...
            axes[0].scatter(failure_temp['Operating_Hours'], failure_temp['Temperature'], color='red', marker='x', s=130, linewidths=2.5, label='Failure')
            ...
            axes[1].scatter(df['Operating_Hours'], df['Vibration'], color='blue', alpha=0.5, s=15, label='Chassis Vibration')
            ...
            axes[1].scatter(failure_vib['Operating_Hours'], failure_vib['Vibration'], color='red', marker='x', s=130, linewidths=2.5, label='Failure')
            ...
            axes[2].scatter(df['Operating_Hours'], df['Pressure'], color='green', alpha=0.5, s=15, label='Hydraulic Oil Pressure')
            ...
            axes[2].scatter(failure_press['Operating_Hours'], failure_press['Pressure'], color='red', marker='x', s=130, linewidths=2.5, label='Failure')
