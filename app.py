...
if uploaded_file is not None:
    try:
        ...
        if all(col in df.columns for col in required_columns):
            ...
            axes[0].plot(smoothed[:, 0], smoothed[:, 1], color='black', linewidth=2, label='LOWESS')
            ...
            axes[1].plot(smoothed[:, 0], smoothed[:, 1], color='black', linewidth=2, label='LOWESS')
            ...
            axes[2].plot(smoothed[:, 0], smoothed[:, 1], color='black', linewidth=2, label='LOWESS')
