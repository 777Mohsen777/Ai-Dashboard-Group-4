...
def gauge_plot(title, value, min_val, max_val, zones, dark_mode=False):
...
def donut_chart(title, percent, color, dark_mode=False):
    ...
    fig.update_layout(paper_bgcolor='#0e1117' if dark_mode else 'white', font_color='white' if dark_mode else 'black')
    return fig
...
if uploaded_file:
    ...
    with c1:
        st.plotly_chart(gauge_plot("Temp (°C)", temp, 0, 150, dark_mode=dark_mode, [((0, 70), "lightgreen"), ((70, 80), "yellow"),
            ((80, 100), "orange"), ((100, 120), "red"), ((120, 150), "black")]), use_container_width=True)
    with c2:
        st.plotly_chart(gauge_plot("Vibration (g)", vib, 0, 2.5, dark_mode=dark_mode, [((0, 0.4), "lightgreen"), ((0.4, 1), "yellow"),
            ((1, 1.5), "orange"), ((1.5, 2), "red"), ((2, 2.5), "black")]), use_container_width=True)
    with c3:
        st.plotly_chart(gauge_plot("Pressure (psi)", pres, 0, 400, dark_mode=dark_mode, [((0, 230), "white"), ((230, 260), "red"),
    ...
    d1, d2, d3 = donut_chart("Temp", r1, c1, dark_mode=dark_mode), donut_chart("Vibration", r2, c2, dark_mode=dark_mode), donut_chart("Pressure", r3, c3, dark_mode=dark_mode)
