...
st.title("📊 Excavator Dashboard (Compact View)")
...
def component_zone(df):
    ...
    for comp in df['Component_Type'].unique():
        ...
        d1, d2, d3 = [int((1 - v/threshold) * 100) for v, threshold in zip(
            [comp_df['Temperature'], comp_df['Vibration'], 400 - comp_df['Pressure']], [150, 2.5, 400])]
        dchart1, dchart2, dchart3 = donut("Temp", d1, "green"), donut("Vib", d2, "blue"), donut("Pres", d3, "red")
